          ...
          if (typeof oHTTP.onload != "undefined") {
            oHTTP.onload = function () {
              if (
                ...
                this.fileSize =
                  iFileSize || this.getResponseHeader("Content-Length");
                fncCallback(this);
              } else {
                if (fncError) fncError();
              }
  ...
  (function () {
    ...
    function readTags(oFile, iTIFFStart, iDirStart, oStrings, bBigEnd) {
      ...
      for (var i = 0; i < iEntries; i++) {
        ...
        if (!strTag && bDebug)
          console.log(
            "Unknown tag: " + oFile.getShortAt(iEntryOffset, bBigEnd)
          );
    ...
    function readTagValue(oFile, iEntryOffset, iTIFFStart, iDirStart, bBigEnd) {
      ...
      var iValueOffset =
        oFile.getLongAt(iEntryOffset + 8, bBigEnd) + iTIFFStart;
...
$(function () {
  var someCallback = function (exifObject) {
    ...
    $("#latitude").val("-" + exifObject.GPSLatitude);
    $("#longtitude").val(exifObject.GPSLongitude);
